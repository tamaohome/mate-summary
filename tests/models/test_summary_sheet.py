...
def test_SummaryProps_等価性のチェック(summary_sheet: SummarySheet):
    item_1 = summary_sheet.descendants[0][0]  # SMA490BW, PL, 19.0
    item_2 = summary_sheet.descendants[1][0]  # SMA490BW, PL, 19.0
    item_3 = summary_sheet.descendants[1][1]  # SMA490AW, PL, 16.0
